...
export class AddTBLOrdersOpShipping1696117453635 implements MigrationInterface {
    name = 'AddTBLOrdersOpShipping1696117453635'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "shipping" ("id" SERIAL NOT NULL, "shippedAt" TIMESTAMP NOT NULL, "phone" character varying NOT NULL, "name" character varying NOT NULL, "address" character varying NOT NULL, "city" character varying NOT NULL, "postCode" character varying NOT NULL, "state" character varying NOT NULL, "country" character varying NOT NULL, CONSTRAINT "PK_0dc6ac92ee9cbc2c1611d77804c" PRIMARY KEY ("id"))`);
